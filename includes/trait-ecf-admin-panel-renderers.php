...
trait ECF_Framework_Admin_Panel_Renderers_Trait {
    ...
    private function render_typography_panel($args) {
        ...
        // Sorted by popularity — most widely used combinations first within each category.
        // Category order is determined by first occurrence.
        $font_pairings = [

            // ── Modern ──────────────────────────────────────────────────────
            [
                'slug'            => 'modern-montserrat',
                'tone_key'        => 'modern',
                'tone'            => __('Modern', 'ecf-framework'),
                'title'           => __('Montserrat & Open Sans', 'ecf-framework'),
                'description'     => __('The most widely used font combination on the web — confident geometric headlines with a neutral, highly readable body.', 'ecf-framework'),
                'heading_family'  => 'Montserrat',
                'body_family'     => 'Open Sans',
                'heading_sample'  => __('The most trusted pair on the web', 'ecf-framework'),
                'body_sample'     => __('Clean, reliable and familiar across every type of website from landing pages to full blogs.', 'ecf-framework'),
            ],
            [
                'slug'            => 'modern-poppins',
                'tone_key'        => 'modern',
                'tone'            => __('Modern', 'ecf-framework'),
                'title'           => __('Poppins & Roboto', 'ecf-framework'),
                'description'     => __('A contemporary rounded headline with the most-used body font on the web — versatile for any modern site.', 'ecf-framework'),
                'heading_family'  => 'Poppins',
                'body_family'     => 'Roboto',
                'heading_sample'  => __('Friendly, modern and instantly familiar', 'ecf-framework'),
                'body_sample'     => __('Poppins brings personality to headings while Roboto keeps body copy neutral and easy on every screen.', 'ecf-framework'),
            ],
            [
                'slug'            => 'modern-systems',
                'tone_key'        => 'modern',
            ...
            [
                'slug'            => 'editorial-spectral',
                'tone_key'        => 'editorial',
                'tone'            => __('Editorial', 'ecf-framework'),
                'title'           => __('Literary Elegance', 'ecf-framework'),
                'description'     => __('A screen-optimised serif headline with a clean humanist body for editorial, journalism and culture sites.', 'ecf-framework'),
                'heading_family'  => 'Spectral',
                'body_family'     => 'Karla',
                'heading_sample'  => __('Stories worth reading twice', 'ecf-framework'),
                'body_sample'     => __('Spectral was designed for screen reading and pairs naturally with Karla for a calm, literary feel.', 'ecf-framework'),
            ],
            ...
            [
                'slug'            => 'classic-crimson',
                'tone_key'        => 'classic',
                'tone'            => __('Classic', 'ecf-framework'),
                'title'           => __('Timeless Craft', 'ecf-framework'),
                'description'     => __('A warm literary serif with a clean humanist sans body for blogs, authors and knowledge-heavy brands.', 'ecf-framework'),
                'heading_family'  => 'Crimson Text',
                'body_family'     => 'PT Sans',
                'heading_sample'  => __('Depth and warmth in every headline', 'ecf-framework'),
                'body_sample'     => __('Crimson Text brings old-world warmth to headings while PT Sans keeps the body grounded and highly readable.', 'ecf-framework'),
            ],
            ...
            [
                'slug'            => 'premium-josefin',
                'tone_key'        => 'premium',
                'tone'            => __('Premium', 'ecf-framework'),
                'title'           => __('Art Deco', 'ecf-framework'),
                'description'     => __('A geometric Art Deco headline with a delicate serif body for fashion, interiors and high-end event brands.', 'ecf-framework'),
                'heading_family'  => 'Josefin Sans',
                'body_family'     => 'Crimson Pro',
                'heading_sample'  => __('Elegant geometry meets refined tradition', 'ecf-framework'),
                'body_sample'     => __('The wide uppercase spacing of Josefin Sans creates a distinctive label feel that the serif body complements beautifully.', 'ecf-framework'),
            ],

            // ── Neutral ─────────────────────────────────────────────────────
            [
                'slug'            => 'neutral-interface',
                'tone_key'        => 'neutral',
                'tone'            => __('Neutral', 'ecf-framework'),
                'title'           => __('Clean Interface', 'ecf-framework'),
                'description'     => __('Two neutral geometric sans fonts that stay out of the way — ideal for dashboards, SaaS products and utility-first layouts.', 'ecf-framework'),
                'heading_family'  => 'Albert Sans',
                'body_family'     => 'DM Sans',
                'heading_sample'  => __('Simple, direct and easy to scan', 'ecf-framework'),
                'body_sample'     => __('Both fonts share a quiet geometric base that keeps the interface clean without feeling cold or corporate.', 'ecf-framework'),
            ],
            [
                'slug'            => 'neutral-geometric',
                'tone_key'        => 'neutral',
                'tone'            => __('Neutral', 'ecf-framework'),
                'title'           => __('Geometric Neutral', 'ecf-framework'),
                'description'     => __('A constructed geometric headline with a rational body font for structured, system-oriented pages.', 'ecf-framework'),
                'heading_family'  => 'Jost',
                'body_family'     => 'IBM Plex Sans',
                'heading_sample'  => __('Structured thinking made visible', 'ecf-framework'),
                'body_sample'     => __('Jost adds subtle geometric character to headings while IBM Plex Sans keeps body text precise and highly readable.', 'ecf-framework'),
            ],
            ...
            [
                'slug'            => 'warm-friendly',
                'tone_key'        => 'warm',
                'tone'            => __('Warm', 'ecf-framework'),
                'title'           => __('Friendly Service', 'ecf-framework'),
                'description'     => __('Rounded, approachable headlines with a reliable body font for coaches, therapists and local service businesses.', 'ecf-framework'),
                'heading_family'  => 'Nunito',
                'body_family'     => 'Open Sans',
                'heading_sample'  => __('Warm, open and easy to trust', 'ecf-framework'),
                'body_sample'     => __('The rounded letterforms feel personal and inviting while the body font keeps longer paragraphs clear and comfortable.', 'ecf-framework'),
            ],
            [
                'slug'            => 'warm-studio',
                'tone_key'        => 'warm',
                'tone'            => __('Warm', 'ecf-framework'),
                'title'           => __('Soft Studio', 'ecf-framework'),
                'description'     => __('Gently rounded headlines with a calm body font for creative studios, wellness brands and personal projects.', 'ecf-framework'),
                'heading_family'  => 'Quicksand',
                'body_family'     => 'Mulish',
                'heading_sample'  => __('Creative work with a human touch', 'ecf-framework'),
                'body_sample'     => __('Both fonts share soft curves that make the layout feel handcrafted and approachable without losing clarity.', 'ecf-framework'),
            ],
            ...
            [
                'slug'            => 'bold-agency',
                'tone_key'        => 'bold',
                'tone'            => __('Bold', 'ecf-framework'),
                'title'           => __('Bold Agency', 'ecf-framework'),
                'description'     => __('A condensed strong headline with a neutral body font for agencies, portfolios and campaigns that need presence.', 'ecf-framework'),
                'heading_family'  => 'Oswald',
                'body_family'     => 'Roboto',
                'heading_sample'  => __('Strong presence, zero compromise', 'ecf-framework'),
                'body_sample'     => __('Oswald commands attention in headings while Roboto provides a familiar, readable foundation for longer content.', 'ecf-framework'),
            ],
            [
                'slug'            => 'bold-impact',
                'tone_key'        => 'bold',
                'tone'            => __('Bold', 'ecf-framework'),
                'title'           => __('High Impact', 'ecf-framework'),
                'description'     => __('A pure display headline with an elegant body font for hero sections, landing pages and brand statements.', 'ecf-framework'),
                'heading_family'  => 'Bebas Neue',
                'body_family'     => 'Raleway',
                'heading_sample'  => __('Headlines that stop the scroll', 'ecf-framework'),
                                    ...
                                    <div class="ecf-font-pairing__footer">
                                        ...
                                        <div class="ecf-font-pairing__footer-row">
                                            ...
                                            <button type="button"
                                                ...
                                                <?php echo esc_html__('Apply pairing', 'ecf-framework'); ?>
                                            </button>
                                        </div>
                                    </div>
                                </article>
