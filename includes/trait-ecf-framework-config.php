...
trait ECF_Framework_Config_Trait {
    protected function defaults() {
        return [
            ...
            'colors' => [
                ['name' => 'primary', 'value' => '#3b82f6', 'generate_shades' => '1', 'shade_count' => 6, 'generate_tints' => '0', 'tint_count' => 6],
                ['name' => 'secondary', 'value' => '#64748b', 'generate_shades' => '1', 'shade_count' => 6, 'generate_tints' => '0', 'tint_count' => 6],
                ['name' => 'accent', 'value' => '#f97316', 'generate_shades' => '1', 'shade_count' => 6, 'generate_tints' => '0', 'tint_count' => 6],
                ['name' => 'surface', 'value' => '#ffffff', 'generate_shades' => '1', 'shade_count' => 6, 'generate_tints' => '0', 'tint_count' => 6],
                ['name' => 'text', 'value' => '#111827', 'generate_shades' => '1', 'shade_count' => 6, 'generate_tints' => '0', 'tint_count' => 6],
            ],
            'radius' => [
    ...
    private function starter_class_library() {
        return [
            'basic' => [
                ...
                ['name' => 'ecf-layrix-section', 'category' => 'sections'],
