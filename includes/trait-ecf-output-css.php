...
trait ECF_Framework_Output_CSS_Trait {
    ...
    public function output_css() {
        ...
        if ($settings['enabled_components']['layout'] === '1') {
            echo ".ecf-container-boxed,.cf-container-boxed,.elementor .ecf-container-boxed,.elementor .cf-container-boxed{width:100%;max-width:min(calc(100% - 2rem), var(--ecf-container-boxed));margin-inline:auto;}";
        }
